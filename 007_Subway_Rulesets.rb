...
#
#===============================================================================
class StandardRulesSubway < SubwayRuleSet
  attr_reader :number

  def initialize(number, level = nil)
    super(number)
    addPokemonRule(StandardRestrictionSubway.new)
...
#
#===============================================================================
class StandardCup < StandardRulesSubway
  def initialize
    super(3, 50)
  end
...
#
#===============================================================================
class DoubleCup < StandardRulesSubway
  def initialize
    super(4, 50)
  end
